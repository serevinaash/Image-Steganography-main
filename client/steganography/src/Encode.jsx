...
const Encode = () => {
    ...
    const handleImageChange = (image) => {
        ...
        if (!image.name.match(/\.(bmp|png|jpg|jpeg)$/)) {
            const error = "Wrong File Type! Choose a PNG, JPG, or BMP file only";
            setError(error);
            setModal(true);
            setLoading(false);
            return;
        ...
        if (image.size > 200000000) {
            const error = "File size over limit! Choose a file below 200MB";
            setError(error);
            setModal(true);
            setLoading(false);
            return;
    ...
    const handleSubmit = async (e) => {
        ...
        // formData.append('key', key); // tambahkan jika backend support
                ...
                <div className="flex flex-col md:flex-row gap-8">
                    ...
                    <div className="flex-1 space-y-4">
                        ...
                        <div>
                            ...
                            <select className="w-full bg-gray-900 p-2 rounded-md">
